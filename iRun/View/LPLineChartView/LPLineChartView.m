...
//        
//        CGColorRef color1 = [UIColor colorWithRed:0.380 green:0.698 blue:0.282 alpha:1.0].CGColor;
//        CGColorRef color2 = [UIColor colorWithRed:0.380 green:0.698 blue:0.282 alpha:0.2].CGColor;
//        
...
- (CALayer *)creatGradient {
    ...
    // [UIColor colorWithRed:0.553 green:0.318 blue:0.565 alpha:1]  [UIColor colorWithRed:0.380 green:0.698 blue:0.282 alpha:1.0]
    CGColorRef color1 = [UIColor colorWithRed:0.553 green:0.318 blue:0.565 alpha:1].CGColor;
    CGColorRef color2 = [UIColor colorWithRed:0.553 green:0.318 blue:0.565 alpha:0].CGColor;
    
    [bgLayer setColors:@[(__bridge id)color1,(__bridge id)color2]];
    [bgLayer setLocations:@[@0.0,@0.9]];
